    ...
    <AppShell active="/events">
      <div className={styles.page}>
        <article className={styles.banner}>
          ...
          {/* B1 — check-in is what puts Jools in a mentee's wallet. */}
          {checkedIn ? (
            <div className={styles.checkedIn}>
              ...
              <div>
                ...
                <p>
                  {tokensGranted
                    ? `${tokensGranted} Jools have been added to your wallet.`
        ...
        <section className={styles.discover}>
          <div>
            ...
            <p>Connect directly with startup founders, tech leaders and industry guides using your Jools.</p>
          </div>
