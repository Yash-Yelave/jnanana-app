...
| 10 | Schedule `741:9308` | `/schedule` | Desktop/tablet/mobile inferred from shared shell | Calendar and time selection | Not started | Not started |
| 11 | Subscription `501:17719` | `/subscription` | Desktop | Plan selection | Not started | Not started |
| 12 | Student profile `897:6163` | `/profile` | 1728, responsive profile variants | Profile summary and navigation | Not started | Not started |
| 13 | Student lessons `897:6702` | `/profile/lessons` | 1728 | Lesson history/status | Not started | Not started |
| 14 | Student feedback `897:6383` | `/profile/feedback` | 1728 | Feedback cards/forms | Not started | Not started |
| 15 | Edit profile `897:8100` | `/profile/edit` | 1728, 1024 `1004:33074`, 390 `1004:33213` | Editable personal details | Not started | Not started |
| 16 | Student dashboard `501:25486` | `/dashboard` | 1728 | Analytics, leaderboard and progress | Not started | Not started |
| 17 | 1:1 meeting `501:26647` | `/meeting` | 1728, responsive meeting variants | Video controls and participants | Not started | Not started |
| 18 | Community room `501:21403` | `/community` | 1728, responsive community variants | Community feed and room navigation | Not started | Not started |
| 19 | Chat room `501:19472` | `/chat` | 1728 | Conversation list and composer | Not started | Not started |
| 20 | Settings `501:23372` | `/settings` | 1728 | Settings navigation, logout overlay | Not started | Not started |
| 21 | Payment `501:24035` | `/payment` | 1728 | Payment UI; provider integration deferred | Not started | Not started |
| 22 | Student referrals `501:24448` | `/referrals` | 1728 | Referral code and sharing | Not started | Not started |
...
|---|---|---|---|---|
| Logout confirmation | `501:23697` | Settings | Log out | Not started |
